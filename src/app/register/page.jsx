...
function StrengthMeter() {
  // Purely decorative UI state for the design — no validation logic wired up
  const [level] = useState(2); // 0–4
  const labels = ["Too short", "Weak", "Fair", "Good", "Strong"];
  const colors = ["#E8DDD0", "#D98C5F", "#C8A97A", "#8FBD84", "#4A6741"];
    ...
    <div className="flex items-center gap-3 px-1">
      <div className="flex gap-1.5 flex-1">
        {[0, 1, 2, 3].map((i) => (
          <motion.div
            key={i}
            className="h-1 flex-1 rounded-full bg-[#E8DDD0] overflow-hidden"
          >
            <motion.div
      ...
      <span
        ...
        style={{ fontFamily: sans, color: colors[level] }}
      >
        {labels[level]}
      </span>
    </div>
...
`}</style>
      ...
      <div className="relative min-h-screen grid lg:grid-cols-[1.05fr_1fr]">
        ...
        ───────────────────────────────────────────────────────────────────── */}
        <section className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-[#1C1C1A] px-14 py-12">
        ...
        {/* ─────────────────────────────────────────────────────────────────────
            RIGHT — Form panel
        ───────────────────────────────────────────────────────────────────── */}
        <section className="relative flex items-center justify-center px-6 sm:px-10 py-14 lg:py-12">
          ...
          >
            ...
            >
              <span className="text-[#1C1C1A]">Join the </span>
              <span className="italic text-[#4A6741]">community</span>
            </h2>
